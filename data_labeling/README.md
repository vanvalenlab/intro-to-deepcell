...
* [Load files](#load-files)
    * drag & drop files onto <a href="label.deepcell.org" target="_blank">label.deepcell.org</a>
    * supported filetypes
...
Want to learn more about the tools available in DeepCell Label? Start with our [guided walkthrough of a provided demo file](DeepCell_Label_interactive_demo.md), or load up a test file from the menu on the <a href="label.deepcell.org" target="_blank">DeepCell Label homepage</a>.
